/**
 * EquilateralAgents™ Security Scanner Agent (Open Core)
 * 
    ...
    async scanDependencies(projectPath) {
        ...
        try {
            ...
            try {
                ...
                // Basic vulnerability database (limited in open core)
                ...
                for (const [pkg, version] of Object.entries(dependencies)) {
                    if (knownVulnPackages[pkg]) {
                        findings.push({
                            ...
                            upgrade_note: 'Commercial tiers include comprehensive vulnerability database'
                        });
                    }
                }
            } catch (err) {
    ...
    async generateSecurityReport(scanResults) {
        ...
        if (this.securityConfig.useFreeScanning) {
            report.upgrade_notes.push(
                'Upgrade to Professional tier for comprehensive vulnerability database',
